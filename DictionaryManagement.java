...
public class DictionaryManagement {
    ...
    public Dictionary insertFromFile(Dictionary dictionary) throws FileNotFoundException {
        ...
        Scanner sc = new Scanner(new File("E:\\IntelliJ IDEA\\IdeaProjects\\Big1\\src\\com\\company\\VN-ENDict.txt")).useDelimiter("\\s*:\\s*");
    ...
    public void dictionaryExportToFile(Dictionary dictionary)
    {
        try
        {
            File file=new File("E:\\IntelliJ IDEA\\IdeaProjects\\Big1\\src\\com\\company\\VN-ENDict.txt");
